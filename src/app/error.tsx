  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col">
      <div className="border-b border-line px-8 py-6">
        <span className="font-mono text-[11px] tracking-[0.4em] uppercase text-dim">Chyba</span>
      </div>

      <div className="flex-1 flex flex-col items-center justify-center px-8 py-24 gap-8">
        <span className="font-anton text-[96px] leading-none text-line select-none">∅</span>
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="font-mono text-[12px] tracking-[0.08em] leading-relaxed text-dim max-w-[36ch]">
            Nastala neočekávaná chyba. Zkus to prosím znovu.
          </p>
        </div>
